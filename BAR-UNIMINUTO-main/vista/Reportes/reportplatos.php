             ...
             <ul class="nav navbar-nav">
                ...
                <br>
                   ...
                   <div class="box" id="contenido">
                    <center>
                   <h4>Reportes compras<br>
                    buscar las compras por fecha de este modo:<br>
                  (aa-mm-dd)</h4>
                   <div class="row-fluid">
...
require("../../modelo/connect_db.php");
 ...
 $buscar = $_POST['T1'];
 $registros=$mysql->query("SELECT id, numeroventa, fecha, hora, id_producto, precio, cantidad, subtotal FROM `compras` WHERE fecha like '%$buscar%' ORDER BY `compras`.`id`  
  DESC") 
 or die($mysql->error);

 echo '<table  id="productos" border="2"; class="table table-hover">';
 echo'<thead>';

 echo '<tr>
            <th class="center">id</th>
            
            <th class="center">numeroventa</th>
            <th class="center">fecha</th>
            <th class="center">hora</th>
            <th class="center">id_producto</th>
