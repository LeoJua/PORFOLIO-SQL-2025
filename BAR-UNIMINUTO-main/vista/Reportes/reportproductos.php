            ...
            <ul class="nav navbar-nav">
                ...
                <br>
                   ...
                   <div class="box" id="contenido">
                    <center>
                   <h4>Reportes de los productos buscar con el comando<br>
                       NOMBRE, CATEGORIAS, PROVEEDOR, PRECIO</h4>
                   <div class="row-fluid">
...
require("../../modelo/connect_db.php");
 ...
 $buscar = $_POST['T1'];
 $registros=$mysql->query("SELECT productos.codigo, productos.nombre,categorias_productos.nombre as nombrecategoria, 
 	...
 	WHERE productos.precio like '%$buscar%' 
 	or categorias_productos.nombre like '%$buscar%'
 	or proveedores.nombre like '%$buscar%'
