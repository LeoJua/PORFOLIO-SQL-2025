            ...
            <ul class="nav navbar-nav">
                ...
                <br>
                   ...
                   <div class="box" id="contenido">
                    <center>
                   <h4>Reportes reservas<br>
                    buscar mediante el codigo<br>
                  (NOMBRE, FECHA, MESA)</h4>
                   </center>
...
require("../../modelo/connect_db.php");
 ...
 $buscar = $_POST['T1'];
 $registros=$mysql->query("SELECT reservas.id,registro.Documento as id_usuario,reservas.fecha,reservas.hora,reservas.zonahoraria,mesa.numdepersonas as id_mesa,reservas.estado 
          FROM reservas
  ...
  or reservas.fecha like '%$buscar%'
  or mesa.id like '%$buscar%'


   
   
   
  ORDER BY `reservas`.`id` ASC") 
 or die($mysql->error);

 echo '<table  id="" border="2"; class="table table-hover">';
 echo'<thead>';
 ...
 echo '<tr>
            ...
            <th class="center">zonahoraria</th>
