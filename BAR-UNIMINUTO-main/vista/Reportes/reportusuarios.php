             ...
             <ul class="nav navbar-nav">
                ...
                <br>
                   ...
                   <div class="box" id="contenido">
                    <center>
                   <h4>Reportes de los usuarios, buscar con el comando:<br>
                       NOMBRE, ROL</h4>
                   <div class="row-fluid">
...
require("../../modelo/connect_db.php");
 ...
 $buscar = $_POST['T1'];
 $registros=$mysql->query("SELECT codigo,nombre,Apellido, Documento, password, fecha, genero, telefono, rol FROM `registro` WHERE nombre like '%$buscar%' or rol like '%$buscar%' ORDER BY `registro`.`codigo`  ASC") 
 or die($mysql->error);
